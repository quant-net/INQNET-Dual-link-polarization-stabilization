...
if __name__ == "__main__":
    ...
    OSW_operate(OSW=None, Alice_Switch_status=0, Bob_Switch_status=1, meas_device=Charlie.NIDAQ_USB, channels=[1, 2, 3, 4], log_file=log_file, initCheck = True,
                Alice=Alice, Bob=Bob)
