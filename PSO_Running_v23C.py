...
class PSOParams:
    def __init__(self, Alice, Bob, Charlie, Measure_CostFunction, log_event, log_file, meas_device):
        ...
        self.threshold_cost2 = 0.025#0.025#
...
if __name__ == "__main__":
    ...
    duration = 60 * 60 # amount of time to run the stabilization algorithm for
    ...
    Charlie.Rigol.ch1_params = Charlie.Rigol.set_channel_params(channel="1", burst_delay=47E-6,burst_cycles=800, trigger_source="EXT")
    Charlie.Rigol.ch2_params = Charlie.Rigol.set_channel_params(channel="2", burst_delay=0 ,   burst_cycles=800, trigger_source="EXT")
