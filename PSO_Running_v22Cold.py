...
class PSOParams:
    def __init__(self, Alice, Bob, Charlie, Measure_CostFunction, log_event, log_file, meas_device):
        ...
        self.max_iter = 20
        self.threshold_cost1 = 0.015
        self.threshold_cost2 = 0.025
...
def OSW_operate(OSW, Alice_Switch_status, Bob_Switch_status, meas_device, channels, log_file, initCheck = False,
    ...
    while True:
        ...
        if initCheck:
            ...
            if abs(power_check / reference_power - 1) < 0.2: # TODO Most likely need to change this tolerance here
                success = True
                break
...
if __name__ == "__main__":
    ...
    Charlie.Rigol.ch1_params = Charlie.Rigol.set_channel_params(channel="1", burst_delay=47E-6, trigger_source="EXT")
    Charlie.Rigol.ch2_params = Charlie.Rigol.set_channel_params(channel="2", burst_delay=0, trigger_source="EXT")
